...
export function Editor() {
    ...
    return (
        <>
            <div className="flex flex-col bg-gradient-to-t from-[#272822] to-[#191520] w-[45%] h-[85%] m-10 mt-6 shadow-2xl drop-shadow-2xl rounded-sm">
                <div className="h-[7%] bg-slate-400 rounded-t-sm flex flex-row items-start gap-1"> {/* header */}
