...
export function CodePreview() {
    return (
        <div className=" text-cyan-100 bg-gradient-to-br from-gray-800 to-violet-900 w-[45%] h-[90%] rounded-sm m-10 shadow-2xl drop-shadow-2xl flex items-center flex-col align-middle">
            <img
